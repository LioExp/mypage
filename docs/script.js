...
const icons = {
  ...
  eye: '<svg class="visitor-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>'
};
...
function renderFooter(data) {
  ...
  $('footer').innerHTML = `
    <div class="footer-inner">
      ...
      <span class="visitor-counter" id="visitorCounter">${icons.eye}<span class="visitor-num">—</span></span>
    </div>`;
}
