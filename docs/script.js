...
const TECH_ICONS = {
  ...
  'SQLite': '<svg class="tech-icon" viewBox="0 0 24 24" fill="none"><ellipse cx="12" cy="5" rx="8" ry="3" fill="#44A2C9"/><path d="M4 5v14c0 1.7 3.6 3 8 3s8-1.3 8-3V5" stroke="#44A2C9" stroke-width="1.5" fill="none"/><ellipse cx="12" cy="5" rx="8" ry="3" fill="#44A2C9"/><ellipse cx="12" cy="19" rx="8" ry="3" fill="#44A2C9"/></svg>',
  'MySQL': '<svg class="tech-icon" viewBox="0 0 24 24" fill="none"><ellipse cx="12" cy="5" rx="8" ry="3" fill="#00758F"/><path d="M4 5v14c0 1.7 3.6 3 8 3s8-1.3 8-3V5" stroke="#00758F" stroke-width="1.5" fill="none"/><ellipse cx="12" cy="5" rx="8" ry="3" fill="#00758F"/><ellipse cx="12" cy="19" rx="8" ry="3" fill="#00758F"/></svg>',
};
