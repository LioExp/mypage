const t = {
  pt: {
    ...
    projects: {
      ...
      waitingProjects: [{ name: "SIM Alert AO", desc: "Alertas silenciosos por tempo de dados na rede" }, { name: "FileFlow", desc: "Transferência e automação de ficheiros locais" }, { name: "Rocket", desc: "Construção API inteligente com IA. Alta 2030." }]
    },
    skills: {
  ...
  en: {
    ...
    projects: {
      ...
      waitingProjects: [{ name: "SIM Alert AO", desc: "Silent alerts for mobile data time on the network" }, { name: "FileFlow", desc: "Local file transfer and automation" }, { name: "Rocket", desc: "AI-powered smart API builder. ETA 2030." }]
    },
    skills: {
...
function renderProjects(data) {
  ...
  const projects = [
    { id: 'FABER', key: 'faber', barColor: 'bg-red-600/50', barHover: '#C62828', badgeColor: 'rgba(198,40,40,0.12)', badgeText: '#C62828', badgeBorder: 'rgba(198,40,40,0.25)', dotBg: '#C62828', img: 'assets/faber-preview.png', tags: ['Rust', 'llama.cpp', 'CLI', 'LLM local'], imgBg: 'transparent' },
    { id: 'MyFi', key: 'myfi', barColor: 'bg-blue-500/50', barHover: '#3b82f6', badgeColor: 'rgba(59,130,246,0.1)', badgeText: '#3b82f6', badgeBorder: 'rgba(59,130,246,0.2)', dotBg: '#3b82f6', img: 'assets/myfi-preview.png', tags: ['Python', 'CLI', 'Networking', 'Linux'], imgBg: '#050505' },
    { id: 'KiandaBot', key: 'kianda', barColor: 'bg-purple-500/50', barHover: '#7c3aed', badgeColor: 'rgba(124,58,237,0.1)', badgeText: '#7c3aed', badgeBorder: 'rgba(124,58,237,0.2)', dotBg: '#7c3aed', tags: ['Python', 'Evolution API', 'AI', 'WhatsApp'], terminal: true }
  ];
  ...
  return `<div class="project-card">
    ...
    <div class="project-actions">
      ...
      <div class="project-links">
        <a href="#" target="_blank" rel="noopener noreferrer" class="pill-link">${icons.github} GitHub</a>
        <a href="#" target="_blank" rel="noopener noreferrer" class="pill-link">${icons.external} Landing</a>
      </div>
    </div>
...
function renderWaiting(data) {
  $('waitingGrid').innerHTML = data.projects.waitingProjects.map(p =>
    `<div class="waiting-item"><h5 class="waiting-name">${p.name}</h5><p class="waiting-desc">${p.desc}</p></div>`
  ).join('');
}
