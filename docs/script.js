...
function renderProjects(data) {
  ...
  const projects = [
    { id: 'FABER', key: 'faber', barColor: 'bg-red-600/50', barHover: '#C62828', badgeColor: 'rgba(198,40,40,0.12)', badgeText: '#C62828', badgeBorder: 'rgba(198,40,40,0.25)', dotBg: '#C62828', img: 'assets/faber-preview.png', tags: ['Rust', 'llama.cpp', 'CLI', 'LLM local'], imgBg: 'transparent', github: '#', landing: '#' },
