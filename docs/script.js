...
const t = {
  pt: {
    ...
    skills: {
      label: 'SKILLS', heading: 'Onde estou no mapa.', subheading: 'não um inventário — uma trajectória.',
    ...
    setup: {
      label: 'SETUP', heading: 'Onde construo.', sub: 'hardware, software — a bancada.',
  ...
  en: {
    ...
    skills: {
      label: 'SKILLS', heading: 'Where I am on the map.', subheading: 'not an inventory — a trajectory.',
    ...
    setup: {
      label: 'SETUP', heading: 'Where I build.', sub: 'hardware, software — the workbench.',
