const t = {
  pt: {
    ...
    contact: {
      ...
      discord: { name: 'Discord', desc: 'comunidade, debugging, builds ao vivo', handle: 'em breve', href: '#' },
  ...
  en: {
    ...
    contact: {
      ...
      discord: { name: 'Discord', desc: 'community, debugging, live builds', handle: 'coming soon', href: '#' },
      footer: { tagline: 'build. break. document.', colossians: 'Col 3:23' }
    }
  }
};
